...
window.markdownit = (arg) => {
  return new MarkdownIt(arg);
}
...
function updateResult() {
  ...
  if (defaults._view === 'src') {
    ...
    var inlinedHtml = juice(rawHtml, {extraCss: css});
    setHighlightedlContent('.result-src-content', inlinedHtml, 'html');
...
function loadCSS() {
  var target = 'https://cdn.jsdelivr.net/highlight.js/9.1.0/styles/github.min.css';
